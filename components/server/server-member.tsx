...
const roleIconMap={
    ...
    [MemberRole.MODERATOR]:<ShieldCheck className='
     h-4 w-4 ml-2 text-indigo-500'/>,
    [MemberRole.ADMIN]:<ShieldAlert className='
...
export const ServerMember = ({
        ...
        return (
                ...
                className={cn(
                        ...
                        />
                        <p className={cn(
                                "font-semibold text-xm text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300 transition",
