...
import { Edit, FileIcon, ShieldCheck, Trash, Trash2, X } from "lucide-react";
...
export const ChatItem =({
        ...
        return (
                <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full" >
                      ...
                      {canDeleteMessage && (
                         <div className="invisible group-hover:visible flex items-center gap-x-2 absolute p-1 -top-2 right-5 bg-white dark:bg-zinc-800 border rounded-sm">
                           {canEditMessage && (
                           ...
                           {canDeleteMessage && (
                             <ActionTooltip label="Edit">
                               <Trash2 onClick={()=>setIsDeleting(true)} className="cursor-pointer ml-auto w-4 h-4 text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-300 transition" />
                             </ActionTooltip>
                           )}
